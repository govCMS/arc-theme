...
(function ($, window, i) {
  $.fn.responsiveSlides = function (options) {
    ...
    var settings = $.extend({
      ...
      "speed": 1000,            // Integer: Speed of the transition, in
                                // milliseconds
      "timeout": 4000,          // Integer: Time between slide transitions, in
                                // milliseconds
      "pager": false,           // Boolean: Show pager, true or false
      "nav": false,             // Boolean: Show navigation, true or false
      "random": false,          // Boolean: Randomize the order of the slides,
                                // true or false
      "pause": false,           // Boolean: Pause on hover, true or false
      "pauseControls": false,   // Boolean: Pause when hovering controls, true
                                // or false
      "prevText": "Previous",   // String: Text for the "previous" button
      "nextText": "Next",       // String: Text for the "next" button
      "pauseText": "Pause",       // String: Text for the "pause" button
      "maxwidth": "",           // Integer: Max-width of the slideshow, in
                                // pixels
      "controls": "",           // Selector: Where controls should be appended
                                // to, default is after the <ul>
