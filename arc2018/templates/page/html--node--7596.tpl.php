    ...
    <div class="row">
        {{#if institutions}}
          ...
          <table
            ...
            class="table table-bordered era-theme">
            <thead>
              <tr>
                <th class="col-sm-9">
                  Institution
                ...
                <th class="col-sm-1">
                  <a class="footnote-ref" aria-label="2010 - click for footnote" href="#era2010note">2010</a>
                </th>
                <th class="col-sm-1">
                  2012
                </th>
            ...
            <tbody id="outcomes-table-body">
              ...
              <tr>
                ...
                {{#each outcomes.era2010}}
                    <td data-year="2010" data-rating="{{rating}}" aria-label="ERA 2010 rating: {{rating}}"></td>
                {{/each}}
                {{#each outcomes.era2012}}
                    <td data-year="2012" data-rating="{{rating}}" aria-label="ERA 2012 rating: {{rating}}"></td>
                {{/each}}
                {{#each outcomes.era2015}}
                    <td data-year="2015" data-rating="{{rating}}" aria-label="ERA 2015 rating: {{rating}}"></td>
                {{/each}}
              </tr>
              {{/each}}
              {{/each}}
    ...
    <div class="row">
        ...
        <div class="col-md-8 col-md-offset-2">
          ...
          <table
            ...
            class="table table-striped table-bordered era-theme">
            <thead>
              <tr>
                <th class="col-sm-1">
                  FoR
...
<script id="legend-partial" type="text/x-handlebars-template">
            <div id="legend" class="col-md-2 hidden-xs hidden-sm hidden-print" role="contentinfo">
                <table class="table table-bordered era-theme affix"
            title="ERA ratings legend"
            summary="ERA ratings legend that describes the rating scale.">
            <thead>
                <tr>
                    <th class="col-sm-12" colspan=2>Rating Scale</td>
                </tr>
            </thead>
            <tbody>
                <tr>
                    <td class="col-sm-1" data-rating="5" aria-label="ERA rating: 5"></td>
                    <td class="col-sm-5">well above world standard</td>
                </tr>
                <tr>
                    <td class="col-sm-1" data-rating="4" aria-label="ERA rating: 4"></td>
                    <td class="col-sm-5">above world standard</td>
                </tr>
                <tr>
                    <td class="col-sm-1" data-rating="3" aria-label="ERA rating: 3"></td>
                    <td class="col-sm-5">at world standard</td>
                </tr>
                <tr>
                    <td class="col-sm-1" data-rating="2" aria-label="ERA rating: 2"></td>
                    <td class="col-sm-5">below world standard</td>
                </tr>
                <tr>
                    <td class="col-sm-1" data-rating="1" aria-label="ERA rating: 1"></td>
                    <td class="col-sm-5">well below world standard</td>
                </tr>
                <tr>
                    <td class="col-sm-1" data-rating="Not assessed" aria-label="ERA rating: not assessed"></td>
                    <td class="col-sm-5">not assessed due to low volume</td>
                </tr>
                <tr>
                    <td class="col-sm-1" data-rating="Not rated" aria-label="ERA rating: not rated"></td>
                    <td class="col-sm-5">not rated</td>
                </tr>
            </tbody>
        </table>
    </div>
...
jQuery( document ).ready(function() {
    ...
    function getInstitutionNames() {
        return $.getJSON('<?php print $path_to_arc; ?>/resources/data/2015_Institutions.json').then( function (institutionNames, status, jqXHR) {
            //todo handle failure
	...
	function makeLegendSticky(){
	  var stickyElement   = '#legend table',   // the element you want to make sticky
	      bottomElement   = '.content-footer'; // the bottom element where you want the sticky element to stop (usually the footer)
    ...
    function setupHandlebars(){
        ...
        Handlebars.registerPartial('legend', $('#legend-partial').html());
