 ...
 */
function arc_form_system_theme_settings_alter(&$form, &$form_state) {

  // Add CSS & JS.
  drupal_add_css(drupal_get_path('theme', 'arc') . '/css/theme-settings.css', array(
    'group' => CSS_THEME,
    'weight' => 100,
  ));
  drupal_add_js(drupal_get_path('theme', 'arc') . '/js/theme-settings.js');
  ...
  $form['#submit'][] = 'arc_form_system_theme_settings_alter_submit';
 ...
 * @ingroup forms
 */
function arc_form_system_theme_settings_alter_submit(&$form, &$form_state) {
